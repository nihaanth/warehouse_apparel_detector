...
from Apperaters_Detection_Main.predictor_yolo_detector.models.experimental import attempt_load
from Apperaters_Detection_Main.predictor_yolo_detector.utils.datasets import LoadStreams, LoadImages
from Apperaters_Detection_Main.predictor_yolo_detector.utils.general import (
    check_img_size, non_max_suppression, apply_classifier, scale_coords,
    xyxy2xywh, plot_one_box, strip_optimizer, set_logging)
from Apperaters_Detection_Main.predictor_yolo_detector.utils.torch_utils import select_device, load_classifier, \
    time_synchronized
...
class Detector():
    ...
    def __init__(self, filename):
        ...
        self.conf = float(0.5)
        self.source = "./Apperaters_Detection_Main/predictor_yolo_detector/inference/images/"
        self.img_size = int(416)
        self.save_dir = "./Apperaters_Detection_Main/predictor_yolo_detector/inference/output"
        self.view_img = False
        self.save_txt = False
        self.device = 'cpu'
        self.augment = True
