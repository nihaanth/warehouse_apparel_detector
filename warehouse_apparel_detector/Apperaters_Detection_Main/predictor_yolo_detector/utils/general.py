...
from Apperaters_Detection_Main.predictor_yolo_detector.utils.google_utils import gsutil_getsize
from Apperaters_Detection_Main.predictor_yolo_detector.utils.torch_utils import is_parallel, init_torch_seeds
...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    if isinstance(path, str):  # *.yaml file
        ...
        from Apperaters_Detection_Main.predictor_yolo_detector.utils.datasets import LoadImagesAndLabels
